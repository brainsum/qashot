 ...
 *
 * Modified version of Drupal\Core\Queue\QueueWorkerInterface.
 *
 ...
 * @see plugin_api
 */
interface QAShotQueueWorkerInterface extends PluginInspectionInterface {
   ...
   */
  public function processItem($data, QAShotTestInterface $entity);
