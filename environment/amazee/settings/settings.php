 ...
 *   For settings only for the development environment (
 * devevlopment sites, docker).
 * - development.services.yml
 *   For services only for the development environment
 * (devevlopment sites, docker).
 * - settings.local.php
 *   For settings only for the local environment,
 * this file will not be commited in GIT!
 * - services.local.yml
